  ...
  return (
    <>
      {!todayDataIsLoading && todayData && (
        <div className="text-[#6572aa] bg-[#252733] min-w-80  max-w-90 rounded-lg text-center px-5 py-5 h-70 hover:scale-105 transition-all duration-500">
          <div className="flex justify-start py-2 text-[#c9b26c]">Calories</div>
          <div className="flex justify-between h-50">
            <div>
              <Doughnut data={data} options={doughnutOptions} />
            </div>
            <div className="flex flex-col w-20 text-xs py-8 gap-3">
